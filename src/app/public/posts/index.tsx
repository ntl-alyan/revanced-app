  ...
  return (
    <PublicLayout>
      <Helmet>
        ...
        <meta name="description" content="Stay updated with the latest news, tutorials, and updates about ReVanced and enhanced Android applications" />
        <meta name="keywords" content="revanced, blog, android, mods, tutorials" />
      </Helmet>
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-b from-primary/10 via-background to-background">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto mb-8">
            Stay updated with the latest news, tutorials, and insights about ReVanced and enhanced Android applications
          </p>
              ...
              <>
                ...
                {categories.map((category: any) => (
                  <Button 
                    ...
                    variant="ghost" 
                    className="border border-primary/30 hover:bg-primary/10 hover:border-primary/50"
                    onClick={() => setLocation(`/posts/category/${category.slug}`)}
                  >
                    {category.name}
                  </Button>
                ))}
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="flex flex-col h-full bg-black/20 border border-primary/10 rounded-xl overflow-hidden">
              ...
              >
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <p className="text-white/70 mb-4 line-clamp-3 flex-grow">
                    {post.excerpt || (post.content && post.content.replace(/<[^>]*>?/gm, '').substring(0, 150) + '...')}
                  </p>
          ...
          <div className="text-center py-20">
            ...
            <p className="text-white/70 mb-8">Check back later for updates and new content.</p>
          </div>
        )}
      </div>
    </PublicLayout>
