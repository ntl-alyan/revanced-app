...
const StructuredDataPage = () => {
  ...
  const handleAddSubmit = (e) => {
    ...
    try {
      if (newData.schemaData) {
        JSON.parse(
          typeof newData.schemaData === "string"
            ? newData.schemaData
            : JSON.stringify(newData.schemaData)
        );
      }
  ...
  const filteredData = structuredDataList.filter(
    (data) =>
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end space-x-2">
                              <Button
                                ...
                                onClick={() =>
                                  router.push(
                                    `/admin/structured-data/edit/${data._id}`
                                  )
                                }
                              >
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Create structured data for SEO optimization. This will generate
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewData({ ...newData, entityType: value })
                  }
                >
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewData({ ...newData, entityId: value })
                  }
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewData({ ...newData, schemaType: value })
                  }
                >
                  <SelectTrigger className="col-span-3">
              ...
              <div className="grid grid-cols-4 items-start gap-4">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setNewData({ ...newData, schemaData: e.target.value })
                  }
                />
              </div>
            </div>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this structured data? This action
              cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
