                      ...
                      <CardContent className="pt-6">
                        <div className="grid gap-6">
                          ...
                          {[
                            ...
                            "installation",
                            "faq",
                          ].includes(form.watch(`sections.${index}.type`)) && (
                            <div className="border rounded-md p-4">
                              ...
                              {!form.watch(`sections.${index}.items`)
                                ?.length && (
                                <div className="text-center py-4 text-muted-foreground">
                                  No items added yet. Click "Add Item" to create
                                  one.
                                </div>
                              )}
                            </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="https://example.com/download/file.apk"
                                {...field}
                                value={field.value || ""}
                              />
                            </FormControl>
          ...
          <TabsContent value="translations" className="space-y-6">
            {homepageData && homepageData._id ? (
              ...
              <div className="text-center py-12 text-muted-foreground">
                <p>
                  Please save the homepage content first before adding
                  translations.
                </p>
              </div>
            )}
